...
#define MINSEP_2     300+350          /* min separation in feet */
...
int alt_sep_test_2()
{
    ...
    enabled_2 = High_Confidence_2 && (Own_Tracked_Alt_Rate_2 <= OLEV_2); 
	...
	need_downward_RA_2 = Non_Crossing_Biased_Descend_2() && Own_Above_Threat_2();
