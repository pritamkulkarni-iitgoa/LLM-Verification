...
/* volatile */ int	P1_marking_member_0[3];
/* volatile */ int	P2_is_marked = 5;
/* volatile */ int	P2_marking_member_0[5];
/* volatile */ int	P3_is_marked = 0;
/* volatile */ int	P3_marking_member_0[6];
...
/*   dummy_i = 17; Takes too much time */
   dummy_i = 2;
/*int P1_marking_member_0[3];
int P2_marking_member_0[5];
int P3_marking_member_0[6];*/

  P1_marking_member_0[0]=atoi(argv[1]);
  P1_marking_member_0[1]=atoi(argv[2]); 
  P1_marking_member_0[2]=atoi(argv[3]); 

  P2_marking_member_0[0]=atoi(argv[4]); 
  P2_marking_member_0[1]=atoi(argv[5]); 
  P2_marking_member_0[2]=atoi(argv[6]); 
  P2_marking_member_0[3]=atoi(argv[7]); 
  P2_marking_member_0[4]=atoi(argv[8]); 

  P3_marking_member_0[0]=atoi(argv[9]); 
  P3_marking_member_0[1]=atoi(argv[10]); 
  P3_marking_member_0[2]=atoi(argv[11]); 
  P3_marking_member_0[3]=atoi(argv[12]); 
  P3_marking_member_0[4]=atoi(argv[13]); 
  P3_marking_member_0[5]=atoi(argv[14]); 
   ...
   while (dummy_i > 0) {
      ...
      if ( (P1_is_marked >= 3) &&
         ...
         if (x > y) {
            ...
            P3_is_marked += 3;
	 printf("The results are:  %d, %d, %d",P3_marking_member_0[P3_is_marked+0], P3_marking_member_0[P3_is_marked+1],P3_marking_member_0[P3_is_marked+2]);
	    printf("Results are %d, %d, %d",x,y,z);
	    printf("Results are %d, %d, %d",x,y,z);
  	    printf("Results are %d, %d, %d",x,y,z);
	 ...
	 printf("The results are:  %d, %d, %d",P3_marking_member_0[P3_is_marked+0], P3_marking_member_0[P3_is_marked+1],P3_marking_member_0[P3_is_marked+2]);
      ...
      if ( (P2_is_marked >= 5) &&
         ...
         if ((b > a)) {
				...
				/* demarking of input places */
         P2_marking_member_0[0] = P2_marking_member_0[3]+8;
         P2_is_marked -= 4;
